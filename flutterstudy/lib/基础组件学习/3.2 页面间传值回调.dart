    ...
    return Scaffold(
      ...
      body: Center(
        child:Column(
          ...
          children: <Widget>[
            Text('${productDetailData.produtctTitle},${productDetailData.produtctDesStr}',style: TextStyle(fontSize: 30.0),),
            RaisedButton(
              child: Text('返回商品列表页',style: TextStyle(color: Colors.white)),
              color: Colors.lightBlue,
              onPressed: (){
                //返回回调数据
                Navigator.pop(context,'${productDetailData.produtctTitle}--返回的数据');
              },
            ),
          ],
        )
