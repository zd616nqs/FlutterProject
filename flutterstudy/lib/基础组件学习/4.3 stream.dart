...
class _SteamDemoState extends State<SteamDemo> {
  ...
  late StreamController<String> _streamDemo2;
  late StreamSink _sinkDemo;

  late StreamController<String> _streamDemo3;
  ...
  void initState() {
    ...
    _streamSubscription2 = _streamDemo2.stream
        .listen(onData222, onError: onError222, onDone: onDone222);

    _streamSubscription3 = _streamDemo3.stream
        .listen(onData222, onError: onError222, onDone: onDone222);
    _streamSubscription3 = _streamDemo3.stream
        .listen(onData333, onError: onError222, onDone: onDone222);
